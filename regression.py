...
if confi == '68.2%':
    st.subheader('Predicted Sell-in price of {} is {} and ranging from {} to {}'.format(name, prediction, np.round(min7,2), np.round(max7,2)))
elif confi == '86.6%':
    st.subheader('Predicted Sell-in price of {} is {} and ranging from {} to {}'.format(name, prediction, np.round(min8,2), np.round(max8,2)))
elif confi == '95%':
    st.subheader('Predicted Sell-in price of {} is {} and ranging from {} to {}'.format(name, prediction, np.round(min9,2), np.round(max9,2)))    
else:
    st.subheader('Predicted Sell-in price of {} is {} and ranging from {} to {}'.format(name, prediction, np.round(min99,2), np.round(max99,2)))  
