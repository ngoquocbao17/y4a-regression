...
if confi == '68.2%':
    ...
    st.subheader('Sell-in price of {} ranging from {} to {}'.format(name, np.round(min8,2), np.round(max8,2)))
elif confi == '95%':
    st.subheader('Sell-in price of {} ranging from {} to {}'.format(name, np.round(min9,2), np.round(max9,2)))    
else:
    st.subheader('Sell-in price of {} ranging from {} to {}'.format(name, np.round(min99,2), np.round(max99,2)))  
